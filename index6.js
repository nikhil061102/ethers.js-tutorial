...
const myAddress = "0xCe8aeCAb841f25213598e986b533CACFB65e88Be"; 
...
const main = async ()=>{
    ...
    */
    ...
    contract.on("Transfer", printLogs);
    ...
    contract.on(filterTo, printLogs);
    ...
    setTimeout(() => {
        contract.off(filterTo,printLogs);
        console.log('Unsubscribed from the event after a delay second');
    }, 120000);
    setTimeout(() => {
        contract.off("Transfer",printLogs);
        console.log('Unsubscribed from the event after a delay first');
    }, 30000);
};
main();